...
const AuthLoginLawyer = ({ forgot }: { forgot?: string }) => {
      ...
      {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
        <form noValidate onSubmit={handleSubmit}>
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Stack spacing={1}>
                <InputLabel htmlFor="email-lawyer-login">Email Address</InputLabel>
                <OutlinedInput
                  id="email-lawyer-login"
                  type="email"
                  value={values.email}
                  name="email"
                  onBlur={handleBlur}
            ...
            <Grid item xs={12}>
              <Stack spacing={1}>
                <InputLabel htmlFor="password-lawyer-login">Password</InputLabel>
                <OutlinedInput
                  fullWidth
                  error={Boolean(touched.password && errors.password)}
                  id="password-lawyer-login"
...
export default AuthLoginLawyer;
